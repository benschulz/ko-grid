...
;(function(factory) {
    if (typeof define === 'function' && define['amd'])
        define(['require', 'knockout', 'ko-indexed-repeat'], factory);
    else
